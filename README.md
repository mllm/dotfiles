...
#### sh -c "`curl -fsSL https://raw.githubusercontent.com/mllm/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/mllm/dotfiles/master/install.sh`" -s ask
```
